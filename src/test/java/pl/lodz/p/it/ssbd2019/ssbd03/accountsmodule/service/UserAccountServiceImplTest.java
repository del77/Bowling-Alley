...
public class UserAccountServiceImplTest {
    ...
    public void shouldThrowEntityUpdateExceptionWhenUpdateUserCatchesException() {
        ...
        Assertions.assertThrows(EntityUpdateException.class, () -> userService.updateUser(mock(UserAccount.class)));
    }
    ...
    @Test
    void unlockLockedAccountTestShouldNotThrow() {
        ...
        try {
            Assertions.assertTrue(userService.unlockAccountById(sut.getId()).isAccountActive());
    ...
    @Test
    void unlockUnlockedAccountTestShouldNotThrow() {
